 ...
 * edited by Isabella Phung for UCSC CSE 121 2024 Spring Lab 4.3
 * with IMU related code generated by ChatGPT
 */
#include "lab4_1.c"
#include <stdio.h>
#include <stdlib.h>
...
void hid_demo_task(void *pvParameters)
{
    ...
    while(1) {
        accel_read(distance);
        esp_hidd_send_mouse_value(hid_conn_id, 0, 5*distance[0], 5*distance[1]);
    }
}
